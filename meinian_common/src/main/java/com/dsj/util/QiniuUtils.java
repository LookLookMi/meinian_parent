...
public class QiniuUtils {
    ...
    public  static String accessKey = "6IoL1V7OjbAZScgL9oDrsxY9cTxMRg0aW5F43zix";
    public  static String secretKey = "U457-1GpAGNhHBUisOAQtsgb9QQqOUePrdel7NlJ";
    public  static String bucket = "dsjmeinian";
    ...
    public static void deleteFileFromQiniu(String fileName){
        ...
        try {
            ...
            System.out.println("删除七牛云图片成功"+fileName);
        } catch (QiniuException ex) {
            //如果遇到异常，说明删除失败
